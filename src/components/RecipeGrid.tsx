import { useRecipeStore, COOKING_METHOD_ICONS, getAllCookingMethods } from '@/store/recipeStore';
import RecipeCard from './RecipeCard';
import { UtensilsCrossed, Search } from 'lucide-react';

export default function RecipeGrid() {
  const { recipes, selectedCategory, sortOptions, searchQuery, customCookingMethods } = useRecipeStore();
  ...
  const groupedRecipes = allCookingMethods.reduce((acc, method) => {
    ...
    return acc;
  }, [] as { method: string; recipes: typeof recipes }[]);
